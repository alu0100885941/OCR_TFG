...
print("----- PREPARANDO -----")
for file in listdir("C:/Users/sergm/source/repos/PillowImageGenerator/Output/Train/Samples/Unmodified/NUM"):

    #print("C:/Users/sergm/source/repos/PillowImageGenerator/Output/Train/%s"%file)
    img =cv2.imread("C:/Users/sergm/source/repos/PillowImageGenerator/Output/Train/Samples/Unmodified/NUM/%s"%file)
    X_train.append(img)
    
for file in listdir("C:/Users/sergm/source/repos/PillowImageGenerator/Output/Train/Answers/NUM"):

    #print("C:/Users/sergm/source/repos/PillowImageGenerator/Output/Train/%s"%file)
    fich=open("C:/Users/sergm/source/repos/PillowImageGenerator/Output/Train/Answers/NUM/%s"%file)
    str=fich.read()
...
for file in listdir("C:/Users/sergm/source/repos/PillowImageGenerator/Output/Test/Samples/Unmodified/NUM"):

    #print("C:/Users/sergm/source/repos/PillowImageGenerator/Output/Train/%s"%file)
    img =cv2.imread("C:/Users/sergm/source/repos/PillowImageGenerator/Output/Test/Samples/Unmodified/NUM/%s"%file)
    X_test.append(img)
for file in listdir("C:/Users/sergm/source/repos/PillowImageGenerator/Output/Test/Answers/NUM"):

    #print("C:/Users/sergm/source/repos/PillowImageGenerator/Output/Train/%s"%file)
    file=open("C:/Users/sergm/source/repos/PillowImageGenerator/Output/Test/Answers/NUM/%s"%file)
    str=file.read()
    if(str.isnumeric()):
        Y_test.append(str)
    else:
...
print(X_train.shape)
img=mpimg.imread(X_train[2345])
imgplot = plt.imshow(img)
plt.show()
cv2.waitkey(0)
print(YY_train[2345])
img=mpimg.imread(X_train[1000])
imgplot = plt.imshow(img)
plt.show()
cv2.waitkey(0)
print(YY_train[1000])
img=mpimg.imread(X_train[50])
imgplot = plt.imshow(img)
plt.show()
cv2.waitkey(0)
print(YY_train[50])
img=mpimg.imread(X_train[100])
imgplot = plt.imshow(img)
plt.show()
cv2.waitkey(0)
print(YY_train[100])
...
model = Sequential()
model.add(Conv2D(512, (3,3), activation="relu", input_shape=(X_train[0].shape[0], X_train[0].shape[1], 3)))
...
model.save_weights("model_prueba2NUM.h5")
